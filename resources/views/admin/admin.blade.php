...
<body>
                            ...
                            <div class="mb-md-1 mt-md-1 pb-3">
                                <form method="post" action="{{Route('login.loginUser')}}">
                                    ...
                                    <div class="d-flex justify-content-start align-items-center">
                                        <img src="{{Vite::asset('resources/assets/img/logo-login.png')}}" alt=""
                                            class="rounded-circle w-25 me-3">
                                    ...
                                    <div class="form-floating mb-4 text-dark">
                                        <input type="email" name="email" class="form-control form-control-lg"
                                            id="email-login" placeholder="name@fullcofee.com">
                                        <label for="email-login">Email:</label>
                                    </div>

                                    <div class="form-floating mb-3 text-dark input-group">
                                        <input type="password" class="form-control form-control-lg" id="senha-login"
                                            placeholder="senha" name="password">
                                        <label for="senha-login">Senha:</label>
                                        <i id="verSenha" class="bi bi-eye-slash input-group-text"></i>
                                    </div>

                                    <p class="small mb-4 pb-lg-2" data-bs-toggle="modal"
                                        data-bs-target="#recuperacao-modal"><a class="text-white-50" href="#!">Esqueceu
                                            sua senha?</a></p>

                                    <a href="dashbord.html">
                                        <button data-mdb-button-init data-mdb-ripple-init
                                            class="btn btn-outline-light btn-lg px-5" type="submit">Logar</button>
                                    </a>
                                </form>
                            </div>
            ...
            <div class="modal-content bg-light  ">
                ...
                <div class="modal-body">
                    <div class="form-floating mb-2 text-dark">
                        <input type="email" class="form-control" id="email-login-recupera"
                            placeholder="Digite seu email...">
                        <label for="email-login-recupera">Email:</label>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" onclick="EnviarEmailRecuperacao();"
                        class="btn btn-lg btn-primary">Enviar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    @if(session('erro'))
      <div id="alertTemp" class="alert alert-danger  alert-dismissible fade show position-fixed" role="alert"
          style="width: 100%; top: 10px; text-align: center; z-index: 9999;">
          {{ session('erro') }}
