<x-layoutindex>
    ...
    <div id="destaques" class="container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Cada espresso é uma expressão pura de sabor, simples, mas
                            extraordinariamente cremoso e
                            intenso.</p>
            ...
            <div class="col">
                <div class="card custom-card">
                    <img src="{{Vite::asset('resources/assets/img/Torta de Nozes.jpg')}}"
                        class="card-img-top custom-img" alt="Torta de Nozes">
                    <div class="card-body">
                        <h5 class="card-title">Crocância e Cremozidade</h5>
                        <p class="card-text">Uma torta de nozes com a combinação perfeita de crocância e cremosidade,
                            proporcionando
            ...
            <div class="col">
                <div class="card custom-card">
                    <img src="{{Vite::asset('resources/assets/img/Caramelo Machiatto.jpg')}}"
                        class="card-img-top custom-img" alt="Smootie Caramelo Machiatto">
                    <div class="card-body">
                        <h5 class="card-title"> Frescor Vegano</h5>
                        <p class="card-text">Um smoothie vegano de caramelo, aveia e leite de coco: uma combinação
                            irresistível de
        ...
        <div class="row">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="paragrafo">
                    ...
                    dedicação. Nossa missão é proporcionar uma experiência única para nossos clientes, oferecendo cafés
                    de alta
                    qualidade e um ambiente acolhedor. Além de nossa seleção cuidadosamente escolhida de grãos, nossos
                    baristas
                    são treinados para garantir que cada bebida seja uma obra de arte, desde o expresso perfeito até as
                    criações
                    mais elaboradas. Venha e desfrute de momentos especiais em um espaço onde o aroma do café fresco se
                    mistura
                    com conversas inspiradoras e sorrisos calorosos.Acreditamos que cada visita deve ser especial, e nos
                    esforçamos para que você se sinta parte de nossa família. Com um ambiente que mistura elegância e
                    conforto,
    ...
    <section id="why-us" class="why-us section">
        <div class="container section-title" data-aos="fade-up">
            ...
            <div><span>Na <strong>Full Coffee</strong>, cada grão e xícara refletem nosso compromisso em oferecer uma
                    experiência única, onde o café é mais que uma bebida; é uma arte e uma paixão que compartilhamos com
                    nossos
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card-item">
                        ...
                        <p>Nossa missão é oferecer cafés excepcionais e um atendimento impecável, criando um espaço onde
                            nossos
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-item">
                        ...
                        <p>Nossa visão é ser reconhecida como a melhor cafeteria da região, conhecida pela qualidade dos
                            nossos
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card-item">
                        ...
                        <p><strong>Qualidade:</strong> Utilizamos apenas os melhores grãos de café e ingredientes
                            frescos.</p>
                        <p><strong>Atendimento:</strong> Valorizamos cada cliente e nos esforçamos para proporcionar um
                            serviço
                            amigável e atencioso.</p>
                        <p><strong>Sustentabilidade:</strong> Priorizamos práticas sustentáveis, desde a seleção de
                            nossos
                            fornecedores até a gestão dos resíduos.</p>
                        <p><strong>Paixão:</strong> Amamos o que fazemos e isso se reflete em cada detalhe do nosso
                            trabalho.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-7">
                        ...
                        <p class="mensagem_contato">Tem alguma dúvida ou quer falar conosco? Entre em contato com a
                          nossa equipe,
                          ...
                          <form action="{{Route('home.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" id="telefone"
                                    placeholder="Digite seu Telefone" name="telefone">
                            </div>

                            <div class="mb-3">
                                <label for="mensagem" class="form-label">Sua mensagem:</label>
                                <textarea required class="form-control txt-area-size" id="mensagem"
                                    rows="3" name="mensagem" maxlength="100"></textarea>
                            </div>
