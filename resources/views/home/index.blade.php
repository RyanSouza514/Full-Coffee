...
<div id="carouselExampleCaptions" class="carousel slide">
  ...
  <div class="row"><!-- Inicio ROW Quem somos-->
    ...
    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100"><!-- Inicio Quem Somos-->
      ...
      <hr class="linha">
      <p class="paragrafo">
        Bem-vindo à <strong>Full Coffee</strong>, um lugar onde cada xícara de café é preparada com paixão e dedicação. Nossa missão é proporcionar uma experiência única para nossos clientes, oferecendo cafés de alta qualidade e um ambiente acolhedor. Além de nossa seleção cuidadosamente escolhida de grãos, nossos baristas são treinados para garantir que cada bebida seja uma obra de arte, desde o expresso perfeito até as criações mais elaboradas. Venha e desfrute de momentos especiais em um espaço onde o aroma do café fresco se mistura com conversas inspiradoras e sorrisos calorosos.Acreditamos que cada visita deve ser especial, e nos esforçamos para que você se sinta parte de nossa família. Com um ambiente que mistura elegância e conforto, nossa cafeteria é o local ideal para relaxar e desfrutar de um café de excelência.
      </p>
    ...
    <div class="row gy-4">
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
                ...
                <p>Nossa missão é oferecer cafés excepcionais e um atendimento impecável, criando um espaço onde nossos clientes se sintam em casa e possam desfrutar de momentos especiais.</p>
            </div>
        </div>
        <!-- Card 2 -->
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="card-item">
                ...
                <p>Nossa visão é ser reconhecida como a melhor cafeteria da região, conhecida pela qualidade dos nossos produtos, pela inovação no cardápio e pela excelência no atendimento ao cliente.</p>
            </div>
        </div>
        <!-- Card 3 -->
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="card-item">
                ...
                <p><strong>Atendimento:</strong> Valorizamos cada cliente e nos esforçamos para proporcionar um serviço amigável e atencioso.</p>
                <p><strong>Sustentabilidade:</strong> Priorizamos práticas sustentáveis, desde a seleção de nossos fornecedores até a gestão dos resíduos.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-12 col-md-7"> <!--Inicio Formulário Contato-->
            ...
            <div class="col-12 col-sm-12 col-md-5"> <!--Inicio Google Maps-->
              <iframe class="mapa-embed" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.8683763554345!2d-38.45904362508162!3d-12.980269387335813!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7161b1bacc7fbe1%3A0xe56ff87dd23b7afb!2sSesc%20Casa%20do%20Com%C3%A9rcio!5e0!3m2!1spt-BR!2sbr!4v1721851429817!5m2!1spt-BR!2sbr" width="100%" height="80%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
