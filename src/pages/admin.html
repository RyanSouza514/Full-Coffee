                ...
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-1 mt-md-1 pb-3">
                    ...
                    <div class="form-floating mb-4 text-dark">
                        <input type="email" class="form-control form-control-lg" id="email-login" placeholder="name@fullcofee.com">
                        <label for="email-login">Email:</label>
                      </div>

                    <div class="form-floating mb-3 text-dark input-group">
                        <input type="password" class="form-control form-control-lg" id="senha-login" placeholder="senha">
